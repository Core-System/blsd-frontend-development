      ...
      <div className="flex items-center gap-1 ml-auto">
        ...
        <div className="flex items-center gap-2.5 ml-3 pl-3 border-l border-[#e0ddd0]">
          <div className="text-right">
            <p className="text-xs font-semibold text-gray-800 leading-tight">Dr. Silva</p>
            <p className="text-[10px] text-gray-500 leading-tight">Diretor Clínico</p>
          </div>
          <div className="w-8 h-8 rounded-full bg-[#8B7355] flex items-center justify-center text-white text-xs font-bold overflow-hidden">
            <img
              src="https://api.dicebear.com/7.x/initials/svg?seed=DS&backgroundColor=8B7355&textColor=ffffff"
              alt="Dr. Silva"
          ...
          <button className="flex items-center gap-1.5 text-[#2C3E2D] hover:text-[#1a2a1b] px-2.5 py-1.5 rounded-md border border-[#2C3E2D]/20 hover:bg-[#2C3E2D]/10 transition-all text-[10px] font-bold tracking-wider">
            {iconeSair}
            <span>SAIR</span>
          </button>
        </div>
